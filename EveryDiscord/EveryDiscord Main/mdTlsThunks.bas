...
Public Property Get TlsIsClosed(uCtx As UcsTlsContext) As Boolean
    TlsIsClosed = (uCtx.State = ucsTlsStateClosed) Or (uCtx.State = ucsTlsStateNew)
End Property
...
Debug.Assert pvArraySize(.RemoteExchRandom) = TLS_HELLO_RANDOM_SIZE
        ...
        If uCtx.IsServer Then
            pvBufferReadArray uExpanded, .RemoteMacKey, .MacSize        '--- not used w/ AEAD
            pvBufferReadArray uExpanded, .LocalMacKey, .MacSize         '--- not used w/ AEAD
        Else
            pvBufferReadArray uExpanded, .LocalMacKey, .MacSize         '--- not used w/ AEAD
            pvBufferReadArray uExpanded, .RemoteMacKey, .MacSize        '--- not used w/ AEAD
        End If
...
Public Function pvCryptoInit() As Boolean
...
Public Function pvCryptoHashSha1(baRetVal() As Byte, baInput() As Byte, Optional ByVal Pos As Long, Optional ByVal Size As Long = -1) As Boolean
    Const FUNC_NAME As String = "CryptoHashSha1"
    Dim lPtr As Long
    Dim hHash As Long
...
Public Function pvCryptoOptimizedSha1(baRetVal() As Byte, baInput() As Byte) As Boolean
    Dim lPtr As Long
    Dim hHash As Long
    Dim Size As Long

    Call CopyMemory(lPtr, ByVal ArrPtr(baInput), 4)
    If lPtr <> 0 Then
        Size = UBound(baInput) + 1
    End If

    If Size > 0 Then
        lPtr = VarPtr(baInput(0))
    End If

    ReDim baRetVal(LNG_SHA1_HASHSZ - 1) As Byte
...
Public Function pvCryptoHashSha224(baRetVal() As Byte, baInput() As Byte, Optional ByVal Pos As Long, Optional ByVal Size As Long = -1) As Boolean
...
Public Function pvCryptoHashSha256(baRetVal() As Byte, baInput() As Byte, Optional ByVal Pos As Long, Optional ByVal Size As Long = -1) As Boolean
...
Public Function pvCryptoHashSha384(baRetVal() As Byte, baInput() As Byte, Optional ByVal Pos As Long, Optional ByVal Size As Long = -1) As Boolean
...
Public Function pvCryptoHashSha512(baRetVal() As Byte, baInput() As Byte, Optional ByVal Pos As Long, Optional ByVal Size As Long = -1) As Boolean
...
Public Function pvCryptoHmacSha1(baRetVal() As Byte, baKey() As Byte, baInput() As Byte, Optional ByVal Pos As Long, Optional ByVal Size As Long = -1) As Boolean
...
Public Function pvCryptoHmacSha256(baRetVal() As Byte, baKey() As Byte, baInput() As Byte, Optional ByVal Pos As Long, Optional ByVal Size As Long = -1) As Boolean
...
Public Function pvCryptoHmacSha384(baRetVal() As Byte, baKey() As Byte, baInput() As Byte, Optional ByVal Pos As Long, Optional ByVal Size As Long = -1) As Boolean
...
Public Function pvCryptoAeadChacha20Poly1305Encrypt( _
...
Public Function pvCryptoAeadChacha20Poly1305Decrypt( _
       baNonce() As Byte, baKey() As Byte, _
       baAad() As Byte, ByVal lAadPos As Long, ByVal lAdSize As Long, _
       baBuffer() As Byte, ByVal lPos As Long, ByVal lSize As Long) As Boolean
Debug.Assert pvArraySize(baNonce) = LNG_CHACHA20POLY1305_IVSZ
...
Public Function pvCryptoAeadAesGcmEncrypt( _
       baNonce() As Byte, baKey() As Byte, _
       baAad() As Byte, ByVal lAadPos As Long, ByVal lAdSize As Long, _
       baBuffer() As Byte, ByVal lPos As Long, ByVal lSize As Long) As Boolean
    Dim lAdPtr As Long
...
Public Function pvCryptoAeadAesGcmDecrypt( _
       baNonce() As Byte, baKey() As Byte, _
       baAad() As Byte, ByVal lAadPos As Long, ByVal lAdSize As Long, _
       baBuffer() As Byte, ByVal lPos As Long, ByVal lSize As Long) As Boolean
Debug.Assert pvArraySize(baNonce) = LNG_AESGCM_IVSZ
...
Public Function pvCryptoAeadAesCbcEncrypt( _
       baNonce() As Byte, baKey() As Byte, _
       baBuffer() As Byte, ByVal lPos As Long, ByVal lSize As Long) As Boolean
...
Public Function pvCryptoAeadAesCbcDecrypt( _
       baNonce() As Byte, baKey() As Byte, _
       baBuffer() As Byte, ByVal lPos As Long, ByVal lSize As Long) As Boolean
Debug.Assert pvArraySize(baNonce) = LNG_AESCBC_IVSZ
Debug.Assert pvArraySize(baKey) = LNG_AES128_KEYSZ Or pvArraySize(baKey) = LNG_AES256_KEYSZ
...
Public Sub pvCryptoRandomBytes(ByVal lPtr As Long, ByVal lSize As Long)
    Call CryptGenRandom(m_uData.hRandomProv, lSize, lPtr)
End Sub

Public Function pvCryptoRsaModExp(baBase() As Byte, baExp() As Byte, baModulus() As Byte, baRetVal() As Byte) As Boolean
...
Public Function pvCryptoRsaCrtModExp(baBase() As Byte, baExp() As Byte, baModulus() As Byte, baPrime1() As Byte, baPrime2() As Byte, baCoefficient() As Byte, baRetVal() As Byte) As Boolean
